...
from code_ch import coding_challenge_page, init_challenges_db, handle_daily_challenge_completion
...
# Replace chatbot_widget() with simple_chat_widget() in your main.py
...
if is_authenticated:
    # Add the chatbot to the app - it will appear in the bottom right corner
    setup_chatbot()
