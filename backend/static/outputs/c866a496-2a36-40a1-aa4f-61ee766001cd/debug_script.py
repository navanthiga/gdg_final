...
sound_strip = bpy.context.scene.sequence_editor.sequences.new_sound(
    name="Audio",
    filepath=r"static/outputs\\c866a496-2a36-40a1-aa4f-61ee766001cd\\audio.mp3",
    channel=1,
    frame_start=1
)
...
# Set output path
scene.render.filepath = r"static/outputs\\c866a496-2a36-40a1-aa4f-61ee766001cd\\video.mp4"
